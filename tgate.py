...
class IFGate(object):
    def __init__(self, W_in=init.Normal(0.1), W_hid=init.Normal(0.1),
                 W_cell=init.Normal(0.1), W_dif=init.Normal(0.1),
                 b=init.Constant(0.),
                 nonlinearity=nonlinearities.sigmoid):
        self.W_in = W_in
        self.W_hid = W_hid
...
class DurationGate(object):

    def __init__(self, W_x=init.Normal(0.1), W_d=init.Normal(0.1),
                 b=init.Constant(0.),
...
# class DurationGate(object):
#
#     def __init__(self, W_d=init.Normal(0.1),
#                  # b=init.Constant(0.),
#                  nonlinearity=nonlinearities.tanh):
#         self.W_d = W_d
#         # self.b = b
